...
import { popularHomeProjects } from '../../data/popularHomeProjects';

export function PopularHomeProjects() {
  return (
      ...
      <div className="box-border caret-transparent mb-12 md:mb-[72px]">
        <div className="box-border caret-transparent">
          <div className="box-border caret-transparent flex flex-col pb-6 md:flex-row">
            <h2 className="text-[color(srgb_0.156863_0.156863_0.152941)] text-2xl font-bold box-border caret-transparent grow col-end-[-1] col-start-1 leading-[38px] text-left ml-6 mr-auto md:ml-0">Popular home projects</h2>
          </div>
